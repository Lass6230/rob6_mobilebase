...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.profile',         'default': '640,480,3', 'description': 'depth module profile'},                           
                           {'name': 'enable_depth',                 'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'rgb_camera.profile',           'default': '640,480,3', 'description': 'color image width'}, 
                           ...
                           {'name': 'pose_fps',                     'default': '2', 'description': "''"},                           
                           {'name': 'pointcloud.enable',            'default': 'false', 'description': 'enable point cloud topic'},
                           {'name': 'pointcloud.stream_filter',     'default': '2', 'description': 'texture stream for pointcloud'},
                           {'name': 'pointcloud.stream_index_filter','default': '-1', 'description': 'texture stream index for pointcloud'},
                           {'name': 'enable_sync',                  'default': 'true', 'description': "'publish individual topics color and depth at the same time(larger input lag, smaller shutter effect)'"},                           
                           ...
                           {'name': 'temporal_filter.enable',              'default': 'true', 'description': 'fast response'},
                           {'name': 'temporal_filter.filter_smooth_alpha', 'default': '0.24', 'description': 'fast response'}, 
                           {'name': 'temporal_filter.filter_smooth_delta', 'default': '5', 'description': 'fast response'}, 
                           
                           {'name': 'spacial_filter.enable',               'default': 'true', 'description': 'fast response'},
                           {'name': 'spacial_filter.filter_magnitude',     'default': '2.0', 'description': 'fast response'},
                           {'name': 'spacial_filter.filter_alpha',     'default': '0.25', 'description': 'fast response'},
                           {'name': 'spacial_filter.filter_delta',     'default': '3.0', 'description': 'fast response'},

                           {'name': 'threshold.filter_delta',     'default': '3.0', 'description': 'fast response'},
                           
                           {'name': 'decimation_filter.enable',     'default': 'true', 'description': 'fast response'},
                           {'name': 'decimation_filter.filter_magnitude',     'default': '2', 'description': 'fast response'},
                           
                           {'name': 'disparity_to_depth.enable',     'default': 'true', 'description': 'fast response'},
                           
                          ]


#rgb topic: /camera/color/image_raw
#aligned depth topic: /camera/aligned_depth_to_color/image_raw
