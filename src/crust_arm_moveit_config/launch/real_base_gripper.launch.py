...
def generate_launch_description():
    ...
    moveit_simple_controllers_yaml = load_yaml(
        "crust_arm_moveit_config", "config/simple_moveit_controllers_gripper.yaml"
    )
    moveit_controllers = {
    ...
    trajectory_execution = {
        ...
        "trajectory_execution.allowed_start_tolerance": 0.09,
    }
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("crust_arm_moveit_config"),
        "config",
        "crust_gripper_ros_controllers.yaml",
    )
    ...
    # Load controllers
    load_controllers = []
    for controller in ["manipulator_position_controllers", "joint_state_broadcaster", "gripper_controller"]:
        load_controllers += [
            ExecuteProcess(
